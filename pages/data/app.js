...
var acc_data = 'Have not yet created an account'
...
document.getElementById('profile_large').src = image

$lang = navigator.language || navigator.userLanguage;
var msg_model = `I am a language model developed by Farel Alfareza.
...
if ($lang = 'id-ID') {
    var msg_model = `Saya adalah model bahasa yang di kembangkan oleh Farel Alfareza.
...
`
    ...
    var acc_data = 'Belum Membuat Akun'
}
document.getElementById('user_name').textContent = storedEmail ? storedEmail : acc_data
...
const handleOutgoingChat = () => {
    ...
    const userMessageHtml = `<div class="message-content">
                             <img class="avatar" onclick="showProfile()" id="profile" src="${image}" alt="User avatar">
                             <p class="text"></p>
                           </div>`;
    ...
    document.getElementById('slide-hide-button').style.display = 'none'
    document.getElementById('slide-chat-button').style.display = 'grid'
    ...
    document.querySelector('.action-buttons').classList.add("x_scroll");
...
document.getElementById('slide-chat-button').addEventListener('click', function() {
    document.getElementById('slide-hide-button').style.display = 'grid'
    document.getElementById('slide-chat-button').style.display = 'none'
    document.body.classList.remove("hide-header");
    document.querySelector(".message").style.display = 'none'
    document.querySelector(".incoming").style.display = 'none'
    document.querySelector('.input-wrapper').style.display = 'none'
    document.querySelector('.typing-form').style.justifyContent = 'center'
    document.querySelector('.typing-form').style.display = 'flex'
})

document.getElementById('slide-hide-button').addEventListener('click', function() {
    document.getElementById('slide-hide-button').style.display = 'none'
    document.getElementById('slide-chat-button').style.display = 'grid'
    document.body.classList.toggle("hide-header");
    document.querySelector(".message").style.display = 'flex'
    document.querySelector('.input-wrapper').style.display = 'flex'
    document.querySelector(".incoming").style.display = 'flex'
})
